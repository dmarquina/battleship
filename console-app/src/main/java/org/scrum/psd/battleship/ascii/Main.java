...
public class Main {
    ...
    private static boolean isValidInput(String positionInput) {
        try {
            Letter.valueOf(positionInput.toUpperCase().substring(0, 1));
            Integer.parseInt(positionInput.substring(1));
        } catch (Exception e) {
            System.err.println("La posición no esta dentro de las posibles opciones");
            return false;
        }
        return true;
    }
